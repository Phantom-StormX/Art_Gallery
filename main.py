...
''')
    ...
    if exhibit_entry == '1':
        which_space = input(''' Awesome! my favorite exhibit! which art piece would you like to see? 
saturn [1] 
rotating galaxy [2] 
northern lights [3] 
mountains [4] 
''')
        ...
        which_pokemon = input(''' Awesome! which art piece would you like to see? 
meowth [1] 
charmander [2] 
squirtle [3] 
ivysaur [4]
''')
        ...
        which_mythology = input(''' Awesome! which art piece would you like to see? 
dragon [1] 
grim reaper [2] 
gryphon [3] 
mermaid [4] 
''')
        ...
        which_animal = input(''' Awesome! which art piece would you like to see? 
frog [1] 
aardvark [2]
cat [3] 
amoeba [4] 
